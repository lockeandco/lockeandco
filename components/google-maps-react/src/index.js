...
export class Map extends React.Component {
	...
	componentDidUpdate(previousProps, previousState) {
		...
		if (this.props.zoom !== previousProps.zoom) {
			this.map.setZoom(this.props.zoom)
		}

		if (this.props.center !== previousProps.center) {
			this.setState({
		...
		if (this.props.bounds && this.props.bounds !== previousProps.bounds) {
		...
		if (this.props && this.props.google) {
			...
			const mapConfig = Object.assign(
				{},
				{
					...
					clickableIcons: Boolean(this.props.clickableIcons),
